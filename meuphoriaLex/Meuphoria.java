...
EXPRESSÕES
************************************************************/
  final public Type Expression(SemanticRoutines rSem) throws ParseException {
  Type type;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LBRACE:
      jj_consume_token(LBRACE);
  ...
  final public Type Expression00(SemanticRoutines rSem) throws ParseException {
  Token t = null;
  Type tp1, tp2;
  ...
  final public Type Expression01(SemanticRoutines rSem) throws ParseException {
  Token t = null;
  Type tp1, tp2;
  ...
  final public Type Expression02(SemanticRoutines rSem) throws ParseException {
  Token t = null;
  Type tp1, tp2;
  ...
  final public Type Expression03(SemanticRoutines rSem) throws ParseException {
  Token t = null;
  Type tp1, tp2;
  ...
  final public Type Expression04(SemanticRoutines rSem) throws ParseException {
  Token t = null;
  Type tp1, tp2;
  ...
  final public Type Expression05(SemanticRoutines rSem) throws ParseException {
  Token t = null;
  Type tp = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case NOT_OP:
  ...
  final public Type Expression06(SemanticRoutines rSem) throws ParseException {
  Token t;
  Symbol var = null;
  Type tp = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
