...
errors++;
  ...
  final public void variables_declaration() throws ParseException {SemanticRoutines rSem;
rSem = new SemanticRoutines();
  ...
  final public void VarDeclare(SemanticRoutines rSem) throws ParseException {Type type;
    type = DataType(rSem);
    IdentList(rSem, type);
  }
...
/* NAO SEI SE O ENUM EH ASSIM ????????? */
  final public       void EnumDeclare(SemanticRoutines rSem) throws ParseException {Type type;
...
type = Type.Enum;
  ...
  final public void ProcDeclare(SemanticRoutines rSem) throws ParseException {Token t, t2;
        Symbol proc = null;
...
if(proc != null)
  ...
  final public void ProcedureType(SemanticRoutines rSem, Token procType) throws ParseException {Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case PROCEDURE:{
...
if(!t.toString().equals(procType.toString()) && !checkDeclaration)
  ...
  final public java.util.ArrayList<Symbol> ParamList(SemanticRoutines rSem) throws ParseException {Symbol s;
...
{if ("" != null) return parList;}
  ...
  final public Symbol Parameter(SemanticRoutines rSem) throws ParseException {Type type;
              Token t;
    type = DataType(rSem);
    t = jj_consume_token(IDENTIFIER);
if (rSem.searchLevel(t.toString()) == null) {
...
if ( errors != 0 ) {
  ...
  final public int stmblk(SemanticRoutines rSem) throws ParseException {int a = 0;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case EXPORT:
    case GLOBAL:
    case PUBLIC:
...
{if ("" != null) return a;}
  ...
  final public int statement(SemanticRoutines rSem) throws ParseException {Token t;
        int a = 0;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case FALLTHRU:
    case RETRY:
...
{if ("" != null) return a;}
  ...
  final public void WhileStatement(SemanticRoutines rSem) throws ParseException {Token t;
        Type type;
...
if(type != Type.Boolean && !checkDeclaration)
  ...
  final public void IfTest(SemanticRoutines rSem) throws ParseException {Token t;
        Type type;
  ...
  final public void ElsifStatement(SemanticRoutines rSem) throws ParseException {Token t;
        Type type;
...
// MUDAR AINDA ??????????????
  final public void Assignment(SemanticRoutines rSem, Token identifier) throws ParseException {Symbol var;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LBRACKET:
    case COMMA:
    case EQUAL:{
var = rSem.searchLevel(identifier.toString());
  ...
  final public void AssignmentMulti(SemanticRoutines rSem) throws ParseException {Token t;
        int var = 1, exp = 0;
call = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LBRACKET:{
...
if(var != exp && !checkDeclaration) {
  ...
  final public void AssignmentWihOp(SemanticRoutines rSem) throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case PLUS:{
  ...
  final public int Return(SemanticRoutines rSem) throws ParseException {Token t;
  int i = 1;
...
if(_return > 0 && _return != i && !checkDeclaration)
  ...
  final public void Call(SemanticRoutines rSem, Token t) throws ParseException {Symbol proc = null;
...
if(checkDeclaration) {
  ...
  final public java.util.ArrayList<Type> ArgList(SemanticRoutines rSem) throws ParseException {Type type;
...
************************************************************/
  final public 
void Sequence(SemanticRoutines rSem) throws ParseException {
...
************************************************************/
  final public 
Type Expression(SemanticRoutines rSem) throws ParseException {Type type;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case LBRACE:{
      Sequence(rSem);
{if ("" != null) return Type.Sequence;}
      break;
      }
    case LPAREN:
    case NOT_OP:
...
*/
  final public void Expression00(SemanticRoutines rSem) throws ParseException {
    Expression01(rSem);
    label_25:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
  ...
  final public void Expression01(SemanticRoutines rSem) throws ParseException {
    Expression02(rSem);
    label_26:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
  ...
  final public void Expression02(SemanticRoutines rSem) throws ParseException {
    Expression03(rSem);
    label_27:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
  ...
  final public void Expression03(SemanticRoutines rSem) throws ParseException {
    Expression04(rSem);
    label_28:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
  ...
  final public void Expression04(SemanticRoutines rSem) throws ParseException {
    Expression05(rSem);
    label_29:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
  ...
  final public void Expression05(SemanticRoutines rSem) throws ParseException {
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case NOT_OP:
    case PLUS:
    case MINUS:{
  ...
  final public void Expression06(SemanticRoutines rSem) throws ParseException {Token t;
  Symbol var = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case INTEGER:
    case FLOAT:
...
call = t;
  ...
  final public void Variable(SemanticRoutines rSem) throws ParseException {
  ...
  final public void Slice(SemanticRoutines rSem) throws ParseException {Type type;
  ...
  final public void Subscripting(SemanticRoutines rSem) throws ParseException {
    jj_consume_token(RBRACKET);
    label_31:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
  ...
  private boolean jj_3R_92()
 {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0xdd636200,0x16000,0x40000000,0x40016000,0x0,0x0,0x0,0x0,0x0,0xdd636200,0x0,0x0,0xdd636200,0x16000,0x40000000,0x40016000,0xdd636200,0x0,0x16000,0x40000000,0x9d620000,0x40016000,0x0,0x19200000,0x0,0x4400000,0x0,0xdd636200,0x0,0x0,0x0,0xdd636200,0x100000,0x0,0x0,0xdd636200,0x100000,0x200,0xdd636200,0x80020000,0x0,0x80000,0x0,0xdd636200,0xdd636200,0xdd636200,0x0,0x20000000,0x0,0x0,0x0,0x0,0xdd636200,0x0,0x0,0x0,0x0,0xdd636200,0xdd636200,0xdd636200,0x80000,0x0,0x0,0x0,0x200,0xdd636200,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x16000,0x0,0x0,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x30f87,0x2,0xd00,0xd02,0x2000000,0x0,0x800,0xd00,0x0,0x30f87,0xd00,0x2000000,0x30f87,0x2,0xd00,0xd02,0x30f87,0x2440000,0x2,0xd00,0x10285,0x20d02,0x0,0x80,0x0,0x10001,0x0,0x30f87,0x20,0x0,0x0,0x30f87,0x0,0x0,0x0,0x30f87,0x0,0x0,0x30f87,0x200,0x40,0x0,0x0,0x30f87,0x30f87,0x30f87,0x8000,0x0,0x0,0x0,0x0,0x0,0x30f87,0x0,0x0,0x0,0x0,0x30f87,0x30f87,0x30f87,0x0,0x1010,0x1010,0x0,0x0,0x30f87,0x2000000,0x2400000,0x400000,0x400000,0x2000000,0x2000000,0x0,0x2000000,0x140000,0x2000000,0x2000000,0x100000,0x100000,0x100000,0x140000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x440000,0x440000,0x40000,0x10800000,0x140000,0x400000,0x140000,0x400000,0x2,0x0,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x20000,0x0,0x20000,0x20000,0x0,0x800,0x20000,0x0,0x20000,0x20000,0x0,0x0,0x20000,0x0,0x20000,0x20000,0x20000,0x85e,0x0,0x20000,0x0,0x20000,0x80000,0x0,0x4000000,0x0,0x0,0x20000,0x0,0x0,0x0,0x20000,0x0,0x0,0x0,0x20000,0x0,0x0,0x20000,0x0,0x0,0x0,0x0,0x20000,0x20000,0x20000,0x0,0x0,0x1,0x6000,0x1,0x6000,0x20000,0x1,0x6000,0x1,0x6000,0x20000,0x20000,0x20000,0x0,0x0,0x0,0x0,0x0,0x20000,0x0,0x85e,0x0,0x0,0x0,0x0,0x5e,0x0,0x43a0007,0x0,0x0,0x7fa0000,0x7fb0000,0x7fa0000,0x43a0007,0xe000,0xe000,0x1f80,0x1f80,0x40,0x6,0x6,0x18,0x18,0x7,0x7,0x0,0x0,0x43a0000,0x0,0x43b0007,0x0,0x43b0007,0x0,0x0,0x300000,0x380000,};
   }
   private static void jj_la1_init_3() {
      jj_la1_3 = new int[] {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40,0x0,0x0,0x20,0x40,0x0,0x0,0x20,0x40,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x40,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,};
   }
